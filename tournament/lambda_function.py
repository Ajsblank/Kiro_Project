...
CHITO_SKILLS = {
  ...
  "남제 치토": [
    {"name":"남제 붕괴","power":60,"cost":70,"range":[[0,1],[0,2]]},
    {"name":"남제 파동","power":20,"cost":15,"range":[[-1,0],[1,0],[0,1]]},
    {"name":"남제 확산","power":40,"cost":50,"range":[[-1,1],[0,1],[1,1],[0,2]]},
    {"name":"남제 견제","power":25,"cost":20,"range":[[0,1]]},
    {"name":"남제 기본타","power":15,"cost":15,"range":[[0,1]]}
  ]
}
